...
$_SESSION['ACTIVITY_NAME'] = "Fractales";
...
$_SESSION['PAGE_ICON_PATH'] = "medias/snowflake.svg";
$_SESSION['PAGE_ICON_ALT'] = "Icône de flocon de neige";
...
<?php
$_SESSION['FOOTER_ACTION_PATH'] = "index.php";
