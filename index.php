...
<!-- position absolue -->
<div class="position-absolute margin-all-45px flexbox flex-direction-row flex-align-items-center flex-row-gap-10px">
    ...
    <div class="flexbox flex-justify-content-center">
        <div class="block flexbox flex-direction-column flex-align-items-center flex-column-gap-20px no-stretch">
            ...
            <div id="grid-container-activities" class="width-50vw">
                ...
                <a class="Rounded-Rectangle flexbox flex-center-center" href="activite-fractales.php">
                ...
                <a class="Rounded-Rectangle flexbox flex-center-center" href="activite-jeu-arduino.php">
                    <div class="flexbox flex-direction-column flex-align-items-center no-stretch">
                ...
                <a class="Rounded-Rectangle flexbox flex-center-center" href="activite-api.php">
                    <div class="flexbox flex-direction-column flex-align-items-center no-stretch">
                ...
                <a class="Rounded-Rectangle flexbox flex-center-center" href="activite-ctf.php">
                    <div class="flexbox flex-direction-column flex-align-items-center no-stretch">
                ...
                <a class="Rounded-Rectangle flexbox flex-center-center" href="activite-cryptographie.php">
                    <div class="flexbox flex-direction-column flex-align-items-center no-stretch">
                ...
                <a class="Rounded-Rectangle flexbox flex-center-center" href="activite-vm.php">
                    <div class="flexbox flex-direction-column flex-align-items-center no-stretch">
