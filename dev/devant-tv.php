            ...
            <div class="flexbox flex-direction-row flex-row-gap-30px flex-grow-horizontal width-40vw">
                ...
                <a class="Rounded-Rectangle flexbox flex-center-center">
                    <div class="flexbox flex-direction-row flex-align-items-center no-stretch">
                        <img src="medias/tv.svg" alt="Icone TV" class="no-stretch"/>
                        <p class="font-accent-color no-stretch">Devant la TV</p>
                    </div>
                </a>

                <a class="Rounded-Rectangle flexbox flex-center-center">
                    <div class="flexbox flex-direction-row flex-align-items-center no-stretch">
                        <img src="medias/logout.svg" alt="Icone ailleurs" class="no-stretch"/>
                        <p class="font-accent-color no-stretch">Ailleurs</p>
                    </div>
                </a>
