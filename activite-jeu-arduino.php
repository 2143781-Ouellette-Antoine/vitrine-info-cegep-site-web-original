...
$_SESSION['ACTIVITY_NAME'] = "Jeu Pong";
...
$_SESSION['PAGE_TITLE'] = "Jeu Pong";
$_SESSION['PAGE_ICON_PATH'] = "medias/gaming-pad.svg";
$_SESSION['PAGE_ICON_ALT'] = "Icône manette de jeu vidéo";
...
<div id="grid-item-activity-description-content">
    ...
    <h2 class="padding-vertical-10px padding-top-30px">Instructions</h2>
    <p class="no-stretch font-accent-color">
        Appuyez sur la manette devant la TV pour démarrer l'application.
        <br><br>
    </p>
    <p>
        - Tappez sur le bouton de la manette quand vous êtes prêt.<br>
        - Utilisez le joystick pour faire monter ou descendre la raquette.
    </p>
</div>
